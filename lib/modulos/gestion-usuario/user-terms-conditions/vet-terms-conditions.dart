...
class VetTermsConditions extends StatefulWidget {
  const VetTermsConditions({Key? key}) : super(key: key);

  @override
  _VetTermsConditionsState createState() => _VetTermsConditionsState();
}

class _VetTermsConditionsState extends State<VetTermsConditions> {
